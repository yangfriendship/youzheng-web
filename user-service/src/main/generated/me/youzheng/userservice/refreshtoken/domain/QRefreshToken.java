...
public class QRefreshToken extends EntityPathBase<RefreshToken> {
    ...
    private static final long serialVersionUID = -706796381L;
    ...
    public final NumberPath<Long> refreshTokenNo = createNumber("refreshTokenNo", Long.class);

    public final me.youzheng.userservice.user.domain.QUser user;
    ...
    public QRefreshToken(Class<? extends RefreshToken> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new me.youzheng.userservice.user.domain.QUser(forProperty("user")) : null;
    }
